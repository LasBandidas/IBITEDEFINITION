...
(() => {
  ...
  const BRANDS = [
    ...
    { name: "Sony",     logo: brandLogo("sony") },
    { name: "LG",       logo: brandLogo("lg") }
  ];

  // Catálogo — sólo categorías y marcas permitidas
  const PRODUCTS = [
    ...
    { id: 16, cat: "auriculares", name: "Auriculares WH-1000XM5",brand: "Sony",   price: 289990,old: null,  rating: 4.9, tag: null,   emoji: "🎧", stock: true },
    { id: 17, cat: "cables",      name: "Cable USB-C a USB-C 2m",brand: "Samsung",price: 5790,  old: null,  rating: 4.3, tag: null,   emoji: "🧵", stock: true },
    { id: 18, cat: "powerbank",   name: "Power Bank 20.000mAh",brand: "LG",       price: 42990, old: null,  rating: 4.7, tag: null,   emoji: "🔋", stock: true },
    ...
    { id: 23, cat: "auriculares", name: "Auriculares LG Tone", brand: "LG",       price: 45990, old: null,  rating: 4.3, tag: null,   emoji: "🎧", stock: true },
  ...
  function brandLogo(id) {
    const svgs = {
      ...
      sony:     `<svg viewBox="0 0 64 24" fill="currentColor"><text x="0" y="18" font-family="Arial,sans-serif" font-size="18" font-style="italic" font-weight="700">SONY</text></svg>`,
      lg:       `<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#a50034"/><text x="16" y="21" text-anchor="middle" font-family="Arial,sans-serif" font-size="13" font-weight="700" fill="#fff">LG</text></svg>`
    };
    return svgs[id] || "";
  }
  ...
  function renderProducts() {
    ...
    grid.innerHTML = list.map(p => `
      <article class="product-card" data-id="${p.id}">
        ...
        ${!p.stock ? `<span class="product-tag stock">Sin stock</span>` : ""}
